...
- **Última tarefa**: Task 1.3 — TurnAggregator wired into app.py pipeline
- **Testes passando**: 370
...
- `_append_transcript()` now accepts both `TranscriptSegment | AggregatedTurn` (both have same fields needed).
