...
def setup_parser() -> argparse.ArgumentParser:
    ...
    reformat_parser.add_argument("-m", "--model", help="Ollama model")
    ...
    summarize_parser.add_argument("-m", "--model", help="Ollama model")
    ...
    extract_parser.add_argument("-m", "--model", help="Ollama model")
